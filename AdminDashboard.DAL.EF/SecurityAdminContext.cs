...
using AdminDashboard.DAL.EF.Mapping;
using AdminDashboard.Entities.Models;

namespace AdminDashboard.DAL.EF
{
    public class SecurityAdminContext : DbContext, IDbContext
    {
        static SecurityAdminContext()
        {
            Database.SetInitializer<SecurityAdminContext>(null);
        }
        ...
        public SecurityAdminContext():base("SecurityAdminDbConnection")
        {
